...
/**
 * jeecg jwt -online表单接口客户端 调用demo
 */
...
//		System.out.println(token);
		...
		// 获取online表单
		// System.out.println("======获取online表单======="+getOnlineForm(token,
		// "jeecg_demo", "4028f6815dd04a04015dd04d4f3e0002"));
		// 删除online表单
		// System.out.println("======删除online表单======="+deleteOnlineForm(token,
		// "jeecg_demo", "4028f6815bd637f1015bd63b3ce60005"));
		// 新增online表单
		System.out.println("======新增online表单======="
				+ addOnlineForm(token, "{\"tableName\":\"jeecg_demo\",\"id\":\"222w2\",\"data\":{\"name\":\"测试vc\"}}"));
		// 修改online表单
		// System.out.println("======修改online表单======="+updateOnlineForm(token,
		// "{\"tableName\":\"jeecg_demo\",\"id\":\"2222\",\"data\":{\"name\":\"测试实现vvc\"}}"));
