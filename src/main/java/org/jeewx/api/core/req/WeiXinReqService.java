...
public class WeiXinReqService {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 * GroupUpdate g = new GroupUpdate(); Group gg = new Group(); gg.setId("111");
			 * gg.setName("test修改"); g.setGroup(gg);
			 */
			...
			g.setAccess_token(
					"bbkXUUyC6F85R_vh7FOokDZn54P4jY6RVg8rvtzd0D10nIgd7Ksg7bBc8mncX6SZ1mMEI7v1q1OBtWoWG8--iR6ohe3kXbx5jUTHGAjGPAU");
