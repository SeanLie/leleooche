...
public enum InterfaceEnum {
    ...
    intertest_get("intertest_get", "微信SWAGER测试", "/rest/interTestController/{id}", "POST", 1),

    wxApiBase_login("wxApiBase_login", "微信授权登陆", "/rest/wxConfigController/wxLogin/{code}", "POST", 1),
    wxApiBase_loginOne("wxApiBase_loginOne", "微信授权登陆2", "/rest/wxApiBaseController/wxLoginOne/{code}", "POST", 2),
    ...
    onlineform_get("onlineform_get", "根据tableName和记录ID获取online表单详细信息",
            "/rest/cgFormDataController/get/{tableName}/{id}", "GET", 1),
    ...
    onlineform_delete("onlineform_delete", "online表单删除一条记录", "/rest/cgFormDataController/delete/{tableName}/{id}",
            "DELETE", 4),
    ...
    InterfaceEnum(String code, String name, String url, String method, Integer sort) {
        this.code = code;
        this.name = name;
        this.url = url;
        this.method = method;
