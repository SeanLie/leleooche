 ...
 * TSUser的Restful API
 * 
 * path/ POST --> 新增 (CREATE) path/id GET --> 查询 (READ) path/id PUT --> 更新
 * (UPDATE) path/id DELETE --> 删除 (DELETE)
 * 
 * @author liuht
 */
@Api(value = "userRest", description = "用户信息管理", tags = "API_UserRest")
@Controller
...
public class UserRestController {
	...
	public ResponseEntity<?> get(
			@ApiParam(required = true, name = "id", value = "用户ID") @PathVariable("id") String id) {
	...
	public ResponseEntity<?> create(@ApiParam(name = "用户对象") @RequestBody TSUser user,
