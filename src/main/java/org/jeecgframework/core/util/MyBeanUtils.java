...
//              String type = origDescriptors[i].getPropertyType().toString();
     ...
     */
    public static void copyBeanNotNull2Bean(Object original, Object target) throws Exception {
        PropertyDescriptor origDescriptors[] = PropertyUtils.getPropertyDescriptors(original);
        for (int i = 0; i < origDescriptors.length; i++) {
            String name = origDescriptors[i].getName();
//          String type = origDescriptors[i].getPropertyType().toString();
            if ("class".equals(name)) {
            ...
            if (PropertyUtils.isReadable(original, name) && PropertyUtils.isWriteable(target, name)) {
                try {
                    Object value = PropertyUtils.getSimpleProperty(original, name);
                    if (value != null) {
