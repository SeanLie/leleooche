 ...
 */
@Controller
@RequestMapping("/wxMediaAPI")
@Api(value = "上传下载多媒体文件", description = "上传下载多媒体文件", tags = "API_wxMedia")
public class JwMediaAPI {
	 ...
	 */
	public static WxUpload uploadMedia(String accessToken, String type, String fileNamePath) throws WexinReqException {
	 ...
	 * @throws WexinReqException
	 */
	public static WxArticlesResponse uploadArticlesByMaterial(String accesstoken, List<WxArticle> wxArticles)
			throws WexinReqException {
		...
		if (wxArticles.size() == 0) {
			...
			if (accesstoken != null) {
				...
				if (result.has("errcode")) {
					logger.error("上传图文消息失败！errcode=" + result.getString("errcode") + ",errmsg = "
							+ result.getString("errmsg"));
					throw new WexinReqException("上传图文消息失败！errcode=" + result.getString("errcode") + ",errmsg = "
							+ result.getString("errmsg"));
				} else {
	...
	public static WxCountResponse getMediaCount(String accesstoken) throws WexinReqException {
		...
		if (accesstoken != null) {
			...
			if (result.has("errcode")) {
				logger.error(
						"上传图文消息失败！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
	 ...
	 * @throws WexinReqException
	 */
	public static WxArticlesRespponseByMaterial getArticlesByMaterial(String accesstoken, String mediaId)
			throws WexinReqException {
		...
		if (accesstoken != null) {
			...
			if (result.has("errcode")) {
				logger.error(
						"获得消息失败！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
				throw new WexinReqException(
						"获得消息失败！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
			} else {
				wxArticlesRespponseByMaterial = (WxArticlesRespponseByMaterial) JSONObject.toBean(result,
	 ...
	 * @throws WexinReqException
	 */
	public static void updateArticlesByMaterial(String accesstoken, WxUpdateArticle wxUpdateArticle)
			throws WexinReqException {
		if (accesstoken != null) {
			...
			if (result.has("errcode") && result.get("errcode") != "0") {
				...
				throw new WexinReqException(
						"消息消息失败！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
			}
		}
	}
	 ...
	 * @throws WexinReqException
	 */
	public static WxNews queryArticlesByMaterial(String accesstoken, String type, int offset, int count)
			throws WexinReqException {
		WxNews wn = null;
		if (accesstoken != null) {
	 ...
	 * @throws Exception
	 */
	public static WxMediaForMaterialResponse uploadMediaFileByMaterial(String accesstoken, WxMediaForMaterial wx)
			throws WexinReqException {
		...
		if (accesstoken != null) {
			...
			String contentType = WeiXinReqUtil
					.getFileContentType(wx.getFileName().substring(wx.getFileName().lastIndexOf(".") + 1));
			...
			if (result.containsKey("errcode")) {
				logger.error(
						"上传媒体资源失败！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
			} else {
	 ...
	 * @throws WexinReqException
	 */
	public static String getMediaIdForMaterial(String accesstoken, WxMediaForMaterial wxMediaForMaterial)
			throws WexinReqException {
	...
	// -- update-begin--Author:gengjiajia Date:2016-11-28 for:TASK #1583
	// 【图文管理】重写管理永久素材的接口
	/**
	 * 新增其他永久素材
	 * 
	 ...
	 * @throws WexinReqException
	 */
	public static WxMediaForMaterialResponse addMediaFileByMaterialNews(String accesstoken, String type,
			String filePath, String fileName) throws WexinReqException {
		WxMediaForMaterialResponse mediaResource = null;
		if (accesstoken != null) {
			...
			if (result.containsKey("errcode")) {
				logger.error("新增其他永久素材 失败！errcode=" + result.getString("errcode") + ",errmsg = "
						+ result.getString("errmsg"));
	 ...
	 * @throws WexinReqException
	 */
	public static WxArticlesResponse uploadArticlesByMaterialNews(String accesstoken, List<WxArticle> wxArticles)
			throws WexinReqException {
		WxArticlesResponse wxArticlesResponse = null;
		if (wxArticles.size() == 0) {
			logger.error("没有上传的图文消息");
			...
			if (accesstoken != null) {
				...
				JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", obj.toString());
				if (result.has("errcode")) {
					logger.error("新增永久图文素材失败！errcode=" + result.getString("errcode") + ",errmsg = "
							+ result.getString("errmsg"));
					throw new WexinReqException(result.getString("errcode"));
				} else {
	 ...
	 * @throws WexinReqException
	 */
	public static void updateArticlesByMaterialNews(String accesstoken, WxUpdateArticle wxUpdateArticle)
			throws WexinReqException {
		if (accesstoken != null) {
			String requestUrl = material_update_news_url.replace("ACCESS_TOKEN", accesstoken);
			...
			if (result.has("errcode") && result.getInt("errcode") != 0) {
				logger.error(
						"修改永久素材失败！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
				throw new WexinReqException(result.getString("errcode"));
			} else {
	 ...
	 * @throws WexinReqException
	 */
	public static List<WxNewsArticle> getArticlesByMaterialNews(String accesstoken, String mediaId)
			throws WexinReqException {
		...
		if (accesstoken != null) {
			...
			if (result.has("errcode")) {
				logger.error(
						"获取永久素材 失败！errcode=" + result.getString("errcode") + ",errmsg = " + result.getString("errmsg"));
				throw new WexinReqException(result.getString("errcode"));
			} else {
	 ...
	 * @throws WexinReqException
	 */
	public static WxNews queryArticlesByMaterialNews(String accesstoken, String type, int offset, int count)
			throws WexinReqException {
		...
		if (accesstoken != null) {
			...
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", obj.toString());
			if (result.has("errcode") && result.getInt("errcode") != 0) {
				logger.error("=====获取素材列表失败！errcode=" + result.getString("errcode") + ",errmsg = "
						+ result.getString("errmsg") + "=====");
				throw new WexinReqException(result.getString("errcode"));
			} else {
	...
	public static void deleteArticlesByMaterialNews(String accesstoken, String mediaId) throws WexinReqException {
		if (accesstoken != null && StringUtils.isNotEmpty(mediaId)) {
			...
			JSONObject result = WxstoreUtils.httpRequest(requestUrl, "POST", obj.toString());
			if (result.has("errcode") && result.getInt("errcode") != 0) {
				logger.error("=====删除永久素材失败！errcode=" + result.getString("errcode") + ",errmsg = "
						+ result.getString("errmsg") + "======");
				throw new WexinReqException(result.getString("errcode"));
			} else {
	...
	// -- update-end--Author:gengjiajia Date:2016-11-28 for:TASK #1583
	// 【图文管理】重写管理永久素材的接口
}
