...
public class JformOrderMain2ServiceImpl extends CommonServiceImpl implements JformOrderMain2ServiceI {
	...
	public void addMain(JformOrderMain2Entity jformOrderMain2, List<JformOrderTicket2Entity> jformOrderTicket2List,
			List<JformOrderCustomer2Entity> jformOrderCustomer2List) {
		// 保存主信息
	...
	public void updateMain(JformOrderMain2Entity jformOrderMain2, List<JformOrderTicket2Entity> jformOrderTicket2List,
			List<JformOrderCustomer2Entity> jformOrderCustomer2List) {
		// 保存主表信息
		if (StringUtil.isNotEmpty(jformOrderMain2.getId())) {
			try {
				JformOrderMain2Entity temp = findUniqueByProperty(JformOrderMain2Entity.class, "id",
						jformOrderMain2.getId());
