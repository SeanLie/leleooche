...
//	public void datagrid(JformOrderTicket2Entity jformOrderTicket2, HttpServletRequest request,
...
//			// 查询条件组装器
//			org.jeecgframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, jformOrderTicket2,
...
//		AjaxJson j = new AjaxJson();
//		message = "订单机票信息更新成功";
//		JformOrderTicket2Entity t = jformOrderMain2Service.get(JformOrderTicket2Entity.class,
//				jformOrderTicket2.getId());
//		try {
...
//			jformOrderTicket2 = jformOrderMain2Service.getEntity(JformOrderTicket2Entity.class,
//					jformOrderTicket2.getId());
...
//	public String exportXls(JformOrderTicket2Entity jformOrderTicket2, HttpServletRequest request,
//			HttpServletResponse response, DataGrid dataGrid, ModelMap modelMap) {
//		CriteriaQuery cq = new CriteriaQuery(JformOrderTicket2Entity.class, dataGrid);
//		org.jeecgframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, jformOrderTicket2,
//				request.getParameterMap());
//		List<JformOrderTicket2Entity> jformOrderTicket2s = this.jformOrderMain2Service.getListByCriteriaQuery(cq,
//				false);
...
//				new ExportParams("订单机票信息列表", "导出人:" + ResourceUtil.getSessionUser().getRealName(), "导出信息"));
...
//	public String exportXlsByT(JformOrderTicket2Entity jformOrderTicket2, HttpServletRequest request,
//			HttpServletResponse response, DataGrid dataGrid, ModelMap modelMap) {
//		modelMap.put(NormalExcelConstants.FILE_NAME, "订单机票信息");
//		modelMap.put(NormalExcelConstants.CLASS, JformOrderTicket2Entity.class);
//		modelMap.put(NormalExcelConstants.PARAMS,
...
//			try {
//				List<JformOrderTicket2Entity> listJformOrderTicket2Entitys = ExcelImportUtil
//						.importExcel(file.getInputStream(), JformOrderTicket2Entity.class, params);
...
//		List<JformOrderTicket2Entity> listJformOrderTicket2s = jformOrderMain2Service
//				.getList(JformOrderTicket2Entity.class);
...
//			@ApiParam(name = "订单机票信息对象") @RequestBody JformOrderTicket2Entity jformOrderTicket2,
