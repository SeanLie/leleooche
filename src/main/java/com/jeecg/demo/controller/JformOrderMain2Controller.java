...
//	public void datagrid(JformOrderMain2Entity jformOrderMain2, HttpServletRequest request,
...
//	@ResponseBody
//	public AjaxJson doAdd(JformOrderMain2Entity jformOrderMain2, JformOrderMain2Page jformOrderMain2Page,
...
//	@ResponseBody
//	public AjaxJson doUpdate(JformOrderMain2Entity jformOrderMain2, JformOrderMain2Page jformOrderMain2Page,
//			HttpServletRequest request) {
//		List<JformOrderTicket2Entity> jformOrderTicket2List = jformOrderMain2Page.getJformOrderTicket2List();
//		List<JformOrderCustomer2Entity> jformOrderCustomer2List = jformOrderMain2Page.getJformOrderCustomer2List();
//		AjaxJson j = new AjaxJson();
...
//	public String exportXls(JformOrderMain2Entity jformOrderMain2, HttpServletRequest request,
...
//			try {
//				List<JformOrderMain2Page> list = ExcelImportUtil.importExcel(file.getInputStream(),
//						JformOrderMain2Page.class, params);
//				JformOrderMain2Entity entity1 = null;
//				for (JformOrderMain2Page page : list) {
//					entity1 = new JformOrderMain2Entity();
//					MyBeanUtils.copyBeanNotNull2Bean(page, entity1);
//					jformOrderMain2Service.addMain(entity1, page.getJformOrderTicket2List(),
//							page.getJformOrderCustomer2List());
//				}
//				j.setMsg("文件导入成功！");
//			} catch (Exception e) {
//				j.setMsg("文件导入失败！");
...
//				new ExportParams("订单主信息列表", "导出人:" + ResourceUtil.getSessionUser().getRealName(), "导出信息"));
...
//					Object id1 = entity.getId();
//					String hql0 = "from JformOrderTicket2Entity where 1 = 1 AND fCK_ID = ? ";
//					List<JformOrderTicket2Entity> jformOrderTicket2OldList = this.jformOrderMain2Service.findHql(hql0,
//							id0);
//					page.setJformOrderTicket2List(jformOrderTicket2OldList);
//					String hql1 = "from JformOrderCustomer2Entity where 1 = 1 AND fK_ID = ? ";
//					List<JformOrderCustomer2Entity> jformOrderCustomer2OldList = this.jformOrderMain2Service
//							.findHql(hql1, id1);
...
//	public ResponseMessage<?> create(@ApiParam(name = "订单主信息对象") @RequestBody JformOrderMain2Page jformOrderMain2Page,
