 ...
 */
@Entity
@Table(name = "auto_user_vehicle", schema = "")
@SuppressWarnings("serial")
public class AutoUserVehicleEntity implements java.io.Serializable {
	/**主键*/
	private java.lang.String id;
	/**用户ID*/
	@Excel(name="用户ID",width=15,dictTable ="t_s_base_user",dicCode ="id",dicText ="realname")
	...
	private java.lang.String carBuyDate;
	/**车辆描述*/
	...
	public java.lang.String getCarBuyDate(){
	 ...
	 */
	public void setCarBuyDate(java.lang.String carBuyDate){
	...
	public java.lang.String getCarDesc(){
		return this.carDesc;
	}
	 ...
	 */
	public void setCarDesc(java.lang.String carDesc){
