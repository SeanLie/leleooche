...
public class TSUserServiceImpl extends CommonServiceImpl implements TSUserServiceI {
	...
	private NamedParameterJdbcTemplate namedParameterJdbcTemplate;
 	...
 	public void delete(TSUserEntity entity) throws Exception{
 		super.delete(entity);
 	}
 	
 	public Serializable save(TSUserEntity entity) throws Exception{
 		Serializable t = super.save(entity);
 		return t;
 	}
 	
 	public void saveOrUpdate(TSUserEntity entity) throws Exception{
