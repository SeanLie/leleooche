...
/**
 * @author zhoujf
 * @date 2016-04-05 参数API类
 */
public class JwParamesAPI {
	// token
	public static String token = "leleooche20180908";
	// 随机戳
	public static String encodingAESKey = "b2rxXq7GMymOskwpkMnwKPctb6ySWnmDQVIu7q0lKOW";
	// 你的企业号ID
	public static String corpId = "wxb3c62b26f2d93948";
	// 管理组的凭证密钥，每个secret代表了对应用、通讯录、接口的不同权限；不同的管理组拥有不同的secret
	public static String secret = "07e2fd71ed57fecc95dae539b2aee7d8";
	// 应用id
