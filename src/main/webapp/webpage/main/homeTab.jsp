...
<div style="display: none">
	<div id="p1" title="JEECG简介" collapsible="true">
		<div title="JEECG简介" collapsible="true" closable="flase" style="height:350px;" >
					...
					<h3>简介</h3>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LELE（J2EE Code Generation）是一款基于代码生成器的智能快速开发平台，引领新开发模式(智能开发\在线开发\插件开发)， 可以帮助解决Java项目80%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。 <br>
					&nbsp;&nbsp;&nbsp;&nbsp;JEECG快速开发宗旨是：简单功能由代码生成器生成使用; 复杂业务采用表单自定义，业务流程使用工作流来实现、扩展出任务接口，供开发编写业务逻辑。 实现了流程任务节点和任务接口的灵活配置，既保证了公司流程的保密性，又减少了开发人员的工作量</p>
					<h3>架构说明</h3>
					<ul>
						<li>LELE开发平台采用SpringMVC+MiniDao+UI快速开发库+ OnlineCoding开发组件 的基础架构,采用面向声明的开发模式， 基于泛型编写极少代码即可实现复杂的数据展示、数据编辑、<br>
						...
						<li>微信管家项目，请下载<a href="http://www.jeewx.com" target="_blank" style="color: red">Jeewx</a>，LELE业务产品</li>
						<li>要求JDK1.6+</li>
					</ul>
					</div>
					<div style="margin-top: 20px;">
					<h3>技术交流</h3>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本系统由LELE开源社区提供，LELE智能快速开发平台，永久开源免费，为大家提供最好的<b>企业二次开发平台</b></p>
					<ul>
