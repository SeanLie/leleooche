...
<div class="row  border-bottom white-bg dashboard-header">
    <div class="col-sm-12">
        <blockquote class="text-warning" style="font-size:14px">您是否需要一款企业级J2EE快速开发平台，提高开发效率，缩短项目周期…
            ...
            <br>…………
            <h4 class="text-danger">那么，现在LELE来了</h4>
        </blockquote>
        <hr>
    </div>
    <div class="col-sm-3">
    ...
    <div class="col-sm-5">
        ...
        <p>LELE是一款基于代码生成器的J2EE快速开发平台，开源界“小普元”超越传统商业企业级开发平台。引领新的开发模式(Online Coding模式(自定义表单)->代码生成器模式->手工MERGE智能开发)， 可以帮助解决Java项目60%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。她可以用于所有的Web应用程序，如:<b>MIS</b>，<b>CRM</b>，<b>OA</b>，<b>ERP</b>，<b>CMS</b>，<b>网站后台</b>，<b>微信管家</b>，等等，当然，您也可以对她进行深度定制，以做出更强系统。</p>
        <p>
            <b>当前版本：</b>v_3.7.8
        </p>
        <p>
                                ...
                                <div id="v53" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <ol>
											...
											<li>【BUG】范围查询double类型字段错误问题;</li>
											<li>【BUG】LELE新版3.7.3菜单加载慢问题解决;</li>
                                ...
                                <div id="v51" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <ol>
											...
											<li>【bug】LELE用户功能代码事务不严谨，control的逻辑改到service里面;</li>
        ...
        <div class="col-sm-4">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <hr>
                    <div class="alert alert-warning">LELE开发平台，可以应用在任何J2EE项目的开发中，尤其适合企业信息管理系统（MIS）、内部办公系统（OA）、企业资源计划系统（ERP） 、客户关系管理系统（CRM）等，其半智能手工Merge的开发方式，可以显著提高开发效率60%以上，极大降低开发成本。
                    </div>
                </div>
            </div>
        </div>
