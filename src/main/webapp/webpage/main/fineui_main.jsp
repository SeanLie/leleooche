...
<head>
	...
	<meta name="keywords" content="LELE 企业级快速开发平台">
    <meta name="description" content="LELE 企业级快速开发平台，她采用强大代码生成，在线开发能力">
...
<body style="overflow-y:hidden;">
	<div class="layout-admin">
		...
		<header class="layout-header">
			<span class="header-logo"><img alt="image" width="190" height="58" src="plug-in/login/images/mobilelogo2.png" /></span>
