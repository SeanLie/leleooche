...
<h3>简介</h3>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LELE（J2EE Code Generation）是一款基于代码生成器的微云快速开发平台，引领新开发模式(智能开发\在线开发\插件开发\移动开发\流程开发)， 可以帮助解决Java项目80%的重复工作，让开发更多关注业务逻辑。既能快速提高开发效率，帮助公司节省人力成本，同时又不失灵活性。 JEECG快速开发宗旨是：简单功能由代码生成器生成使用; 复杂业务采用表单自定义，业务流程使用工作流实现、扩展出业务接口，供开发编写业务逻辑。 实现了流程任务节点和任务接口的灵活配置，既保证了公司流程的保密性，又减少了开发人员的工作量</p>
<h3>适用项目</h3>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LELE快速开发平台，可以应用在任何J2EE项目的开发中，尤其适合企业信息管理系统（MIS）、内部办公系统（OA）、企业资源计划系统（ERP）、客户关系管理系统（CRM）等，其半智能手工Merge的开发方式，可以显著提高开发效率70%以上，极大降低开发成本；JEECG尤为显著的支持SAAS企业级应用开发，插件机制更好的支持了SAAS云应用<font color="red">new</font>需求。</p>
<h3>架构说明</h3>
<ul>
	<li>LELE开发平台，采用SpringMVC + Hibernate + Minidao(类Mybatis) + Easyui(UI库)+ Jquery + Boostrap + Ehcache + Redis + Ztree等基础架构,采用面向声明的开发模式， 基于泛型编写极少代码即可实现复杂的数据展示、数据编辑、表单处理等功能，再配合代码生成器的使用,将J2EE的开发效率提高6倍以上，可以将代码减少60%以上。</li>
	<li>LELE_<font color="red">v_3.7.8 </font>功能点: <b>1.代码生成器</b> <b>2.数据权限</b> <b>3.Online表单</b> <b>4.工作流组件</b> <b>5.移动OA</b> <b>6.EasyPOI工具类</b> <b>7.查询过滤器</b> <b>8.UI库</b> <b>9.国际化</b> <b>10.多数据源</b> <b>11.自定义表单</b> <b>12.在线报表</b> <b>13.移动报表</b> <b>14.日志监控</b> <b>15.首页切换</b> <b>16.插件开发</b></li>
	...
	<li>LELE开发平台，经过专业性能压力测试，保证后台数据的准确性和页面访问速度</li>
...
<h3>技术交流</h3>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本系统由LELE开源社区提供，LELE微云快速开发平台，永久开源免费，为大家提供最好的<b>企业级快速开发平台</b></p>
<ul>
