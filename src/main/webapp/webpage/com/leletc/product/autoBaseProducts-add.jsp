...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="autoBaseProductsController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="productName" name="productName" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value" >
						  	 <textarea style="height:auto;width:95%" class="inputxt" rows="6" id="productDesc" name="productDesc"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
  ...
  <script src = "webpage/com/leletc/product/autoBaseProducts.js"></script>		
