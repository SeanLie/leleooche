...
<form class="form-horizontal" role="form" id="formobj" action="jformOrderMainController.do?doAdd" method="POST">
			...
			<div class="row">
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="orderCode"  type="text" class="form-control input-sm" maxlength="50"  validType="jform_order_main,order_code,id" datatype="*" ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
		            		<div class="input-group input-group-sm">
		            			<input name="orderDate" type="text" class="form-control input-sm laydate-date" value="<fmt:formatDate pattern='yyyy-MM-dd' type='date' value='${orderDate}'/>"  ignore="ignore"  />
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="orderMoney"  type="text" class="form-control input-sm" maxlength="10"  datatype="d" ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="content"  type="text" class="form-control input-sm" maxlength="500"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
				<t:webUploader name="ctype" outJs="true" auto="true" showImgDiv="filediv_ctype" pathValues="${ctype}" datatype="*"></t:webUploader>
