...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="jformTreeController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="name" name="name" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${jformTreePage.name}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="age" name="age" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${jformTreePage.age}'/>
							<span class="Validform_checktip"></span>
