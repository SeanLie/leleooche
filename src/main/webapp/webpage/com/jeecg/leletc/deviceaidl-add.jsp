...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="deviceaidlController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
					     	 <input id="ip" name="ip" type="text" maxlength="36" style="width: 150px" class="inputxt"  datatype="ipv4" ignore="checked" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="port" name="port" type="text" maxlength="10" style="width: 150px" class="inputxt"  datatype="s" ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="boxNum" name="boxNum" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="s" ignore="checked" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="columnNum" name="columnNum" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="s" ignore="checked" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="sleeptime" name="sleeptime" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="n" ignore="checked" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
					     	 <input id="boxTotal" name="boxTotal" type="text" maxlength="32" style="width: 150px" class="inputxt"  datatype="n"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="boxPerson" name="boxPerson" type="text" maxlength="36" style="width: 150px" class="inputxt"  ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	 <input id="awb" name="awb" type="text" maxlength="8" style="width: 150px" class="inputxt"  datatype="awb" ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
							   <input id="onlinetime" name="onlinetime" type="text" style="width: 150px" class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  ignore="ignore" />
							<span class="Validform_checktip"></span>
					...
					<td class="value">
							<input id="popup" name="popup" type="text" style="width: 150px" class="searchbox-inputtext"  ignore="ignore"    />
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value"  colspan="3" >
						  	 <textarea style="height:auto;width:95%" class="inputxt" rows="6" id="desr" name="desr"  ignore="ignore" ></textarea>
							<span class="Validform_checktip"></span>
