...
<t:base type="bootstrap,layer,validform,bootstrap-form"></t:base>
 ...
 <div class="container" style="width:100%;">
	...
	<form class="form-horizontal" role="form" id="formobj" action="infaceAutoOrdersQueueController.do?doAdd" method="POST">
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				...
				<input name="queueDate" type="text" class="form-control laydate-date"  ignore="ignore"  />
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="queueNo" name="queueNo" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入排队编号"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="queueUser" name="queueUser" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入排队用户"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="queueStatus" name="queueStatus" type="text" maxlength="32" class="form-control input-sm" placeholder="请输入排队状态"  ignore="ignore" />
				</div>
			</div>
		</div>
		<div class="form-group">
