...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="autoOrdersCommentController.do?doUpdate" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						    <input id="orderId" name="orderId" type="text" maxlength="36" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${autoOrdersCommentPage.orderId}'/>
					...
					<tr>
						...
						<td class="value">
						    <input id="comments" name="comments" type="text" maxlength="255" style="width: 150px" class="inputxt"  ignore="ignore"  value='${autoOrdersCommentPage.comments}'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
									  <input id="commentTime" name="commentTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore" value='<fmt:formatDate value='${autoOrdersCommentPage.commentTime}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						    <input id="commentUserName" name="commentUserName" type="text" maxlength="32" style="width: 150px" class="inputxt"  ignore="ignore"  value='${autoOrdersCommentPage.commentUserName}'/>
							<span class="Validform_checktip"></span>
