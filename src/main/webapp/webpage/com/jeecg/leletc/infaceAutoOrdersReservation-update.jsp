...
<form class="form-horizontal" role="form" id="formobj" action="infaceAutoOrdersReservationController.do?doUpdate" method="POST">
	<input type="hidden" id="btn_sub" class="btn_sub"/>
	<input type="hidden" id="id" name="id" value="${infaceAutoOrdersReservationPage.id}"/>
	<fieldset>
		<legend>预约订单</legend>
		<div class="main-form">
			<div class="row">
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="productId" value = "${infaceAutoOrdersReservationPage.productId}" type="text" class="form-control input-sm" maxlength="36"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="orderCode" value = "${infaceAutoOrdersReservationPage.orderCode}" type="text" class="form-control input-sm" maxlength="36"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="orderUsers" value = "${infaceAutoOrdersReservationPage.orderUsers}" type="text" class="form-control input-sm" maxlength="36"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
			            	<t:dictSelect field="orderStatus" defaultVal = "${infaceAutoOrdersReservationPage.orderStatus}" type="select" hasLabel="false" title="订单状态" extendJson="{class:'form-control input-sm'}"   typeGroupCode="ord_status" ></t:dictSelect>
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
		            		<div class="input-group input-group-sm">
		            			<input name="orderTime" type="text" class="form-control input-sm laydate-date" value="<fmt:formatDate pattern='yyyy-MM-dd' type='date' value='${infaceAutoOrdersReservationPage.orderTime}'/>"  datatype="*"  ignore="checked"  />
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="orderSort" value = "${infaceAutoOrdersReservationPage.orderSort}" type="text" class="form-control input-sm" maxlength="32"  datatype="n"  ignore="checked"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="parkSpace" value = "${infaceAutoOrdersReservationPage.parkSpace}" type="text" class="form-control input-sm" maxlength="255"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="parkNo" value = "${infaceAutoOrdersReservationPage.parkNo}" type="text" class="form-control input-sm" maxlength="10"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
				<t:webUploader name="parkPhoto" outJs="true" auto="true" showImgDiv="filediv_parkPhoto" type="image" buttonText='添加图片' displayTxt="false" pathValues="${infaceAutoOrdersReservationPage.parkPhoto}"></t:webUploader>
				...
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
							<input name="providerParkNo" value = "${infaceAutoOrdersReservationPage.providerParkNo}" type="text" class="form-control input-sm" maxlength="10"  ignore="ignore"  />
		            	</div>
					</div>
				</div>
				<div class="bt-item col-md-6 col-sm-6">
					<div class="row">
						...
						<div class="col-md-8 col-sm-8 col-xs-8 bt-content">
				<t:webUploader name="providerParkPhoto" outJs="true" auto="true" showImgDiv="filediv_providerParkPhoto" type="image" buttonText='添加图片' displayTxt="false" pathValues="${infaceAutoOrdersReservationPage.providerParkPhoto}"></t:webUploader>
		...
		<div class="tab-pane fade in active" id="infaceAutoOrdersDetail">  
			<div class="form-tb-toolbar">
	   		...
	   		<table class="table subinfo-table" id="infaceAutoOrdersDetail_table">
				...
				<tbody>
				<c:if test="${fn:length(infaceAutoOrdersReservationPage.infaceAutoOrdersDetailList)  > 0 }">
				<c:forEach items="${infaceAutoOrdersReservationPage.infaceAutoOrdersDetailList}" var="poVal" varStatus="stuts">
				<tr>
			  		<td class="form-ck">
			  			<input style="" type="checkbox" name="ck"/>
			  			<input name = "infaceAutoOrdersDetailList[${stuts.index }].id" value= "${poVal.id}" type="hidden"/>
			  		</td>
					<td>
							<input name="infaceAutoOrdersDetailList[${stuts.index }].product" value = "${poVal.product}" type="text" class="form-control input-sm" maxlength="32"  ignore="ignore"  />
					</td>
			  	</tr>
				</c:forEach>
				</c:if>
