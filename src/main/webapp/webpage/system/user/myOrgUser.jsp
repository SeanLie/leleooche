	...
	<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value" width="85%">
                ...
                <c:if test="${user.id==null }">
                    ...
                    <span class="Validform_checktip"> 用户账号不允许更改
                   //<t:mutiLang langKey="username.rang2to18"/>
                    </span>
                </c:if>
            </td>
		</tr>
        ...
        <tr>
            ...
            <td class="value">
                ...
                <t:dictSelect id="personType" field="personType" typeGroupCode="personType" hasLabel="false" defaultVal="${user.personType}"></t:dictSelect>
