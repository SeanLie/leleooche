...
<t:datagrid name="userList" title="common.operation" actionUrl="userController.do?datagrid" fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate,userName" sortOrder="asc,desc">
	...
	/*<t:dgCol title="common.wxopenid" field="wxopenid" hidden="true" width="100"></t:dgCol>
	<t:dgCol title="common.province" field="province" hidden="true" width="100"></t:dgCol>
	<t:dgCol title="common.city" field="city" hidden="true" width="100"></t:dgCol>
	<t:dgCol title="common.country" field="country" hidden="true" width="100"></t:dgCol>*/
